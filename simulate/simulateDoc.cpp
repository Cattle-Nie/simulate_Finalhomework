...
// simulateDoc.cpp: CsimulateDoc 类的实现
//
...
CsimulateDoc::CsimulateDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CsimulateDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CsimulateDoc::InitializeSearchContent()
{
...
void CsimulateDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
